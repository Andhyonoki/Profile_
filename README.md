...
<p align="center">
  <picture>
    <source media="(max-width: 760px) and (prefers-color-scheme: dark)" srcset="./assets/hero/agent-console-4b4000b4-mobile-dark.svg">
    <source media="(max-width: 760px)" srcset="./assets/hero/agent-console-4b4000b4-mobile-light.svg">
    <source media="(prefers-color-scheme: dark)" srcset="./assets/hero/agent-console-4b4000b4-dark.svg">
    <source media="(prefers-color-scheme: light)" srcset="./assets/hero/agent-console-4b4000b4-light.svg">
    <img src="./assets/hero/agent-console-4b4000b4-dark.svg" alt="ARYANDI - SE" width="100%">
  </picture>
</p>
